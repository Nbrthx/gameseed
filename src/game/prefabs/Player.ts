...
export class Player extends Phaser.GameObjects.Container{
    ...
    constructor(scene: Game, x: number, y: number, uid: string, username: string){
        ...
        this.sprite = scene.add.sprite(0, -36, 'male').setOrigin(0.5, 0.5).setScale(scene.gameScale)
        ...
        this.add([shadow, this.aimAssist, this.sprite, this.itemIcon, this.emptyBar, this.damageBar, this.healthBar, this.nameText])
    }
    ...
    update(){
        ...
        if(this.aimAssist.visible) this.aimAssist.setFillStyle(0xffffff, 0.5)
